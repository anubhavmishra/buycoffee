...
This page is generated by a futuristic technology called "Go templates". It uses serverless platform to run and golang 
...
func HandleTemplate(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println(err.Error())
		errMessage = "Inventory isn't available! Please try again later. ☕"
	}
